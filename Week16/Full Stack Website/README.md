...
Live URL (Production): [Add your Render URL here after deployment]

# Week 16 - Hawaii Hospitality Dashboard
...
![Home page screenshot](docs/screenshots/01-home.png)

### Visitor Dashboard

![Visitor dashboard screenshot](docs/screenshots/02-dashboard.png)
...
- GitHub Copilot: scaffolding Express routes, authentication wiring, EJS view structure, and test boilerplate.
